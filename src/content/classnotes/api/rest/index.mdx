...
[Código Fonte](https://github.com/ifpb/pw2/tree/main/public/codes/api/rest/) (Requisição | [REST Client](https://marketplace.visualstudio.com/items?itemName=humao.rest-client)):
...
| GET    | `/repos/luizchaves/pw2`                 | `200`  | Retorna o repositório com nome luizchaves/pw2  |
| PATCH  | `/repos/luizchaves/pw2`                 | `200`  | Atualiza o repositório com nome luizchaves/pw2 |
| DELETE | `/repos/luizchaves/pw2`                 | `204`  | Exclui o repositório com nome luizchaves/pw2   |
