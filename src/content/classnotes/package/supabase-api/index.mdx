...
<RestApiSelector restClientSrc="/codes/package/supabase-api/create-investment.http" curlSrc="/codes/package/supabase-api/create-investment.sh" />
...
<RestApiSelector restClientSrc="/codes/package/supabase-api/read-investments.http" curlSrc="/codes/package/supabase-api/read-investments.sh" />
...
<RestApiSelector restClientSrc="/codes/package/supabase-api/read-investment.http" curlSrc="/codes/package/supabase-api/read-investment.sh" />
...
<RestApiSelector restClientSrc="/codes/package/supabase-api/update-investment.http" curlSrc="/codes/package/supabase-api/update-investment.sh" />
...
<RestApiSelector restClientSrc="/codes/package/supabase-api/delete-investment.http" curlSrc="/codes/package/supabase-api/delete-investment.sh" />
